...
%WINDOWS 8 ou WINDOWS PHONE ??

	%One can see that more than 70\% of voters prefered flat designed icons(IOS7,Android,Windows phone) than skeuomorphic icons.
    ...
    %The main problem with this study is the fact that there isn't any "skeuomorphic" comparable alternatives for Android and windows phone. Results are also influenced by the majority number of flat icons in the survey. However, the calendar icon of windows phone obtain a low number of votes. This could be explained by the fact that its design is very different from the three others calendar icon and can confuse perception of the users.
	...
	%That being said ==> However   = Neanmoins
...
Skeuomorph designs were the norm when touch-based devices were first introduced to the public and have greatly helped their wide adoption. However, it now seems that both designers and users have grown tired of the inherent limitations of such designs. This lead to the current shift to more minimalist designs with sharp edges and bright colors, or Flat design.\\
