...
\begin{block}
A conceptual model of an application is the model of the application that the designers want users to understand.%http://boxesandarrows.com/conceptual-models-in-a-nutshell/
\end{block}
